...
import driverTestRouter from './routers/driver.test.router.js';
import adminTestRouter from './routers/admin.test.router.js';
import academyRouter from './routers/academy.router.js';
...
app.use('/api/driver-test', driverTestRouter);
